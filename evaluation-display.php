...
<div id="Summary" class="tabcontent">
  ...
  <div class="cards">
        ...
        <?php //For total number of Participants for selected Evaluation
          $e_count = "SELECT COUNT(*) AS totalcount FROM evaluation WHERE acty_id='$evaluationID' ";
        ...
        <table class="subtable">
          <?php //For Age Range COUNT
            $agecount = "SELECT age_range,
                        ...
                        FROM evaluation WHERE acty_id='$evaluationID' ";
      ...
      <div class="card">
        <?php
          $gender_count = "SELECT COUNT(CASE WHEN gender='Male' THEN 1 END) AS 'MALE', COUNT(CASE WHEN gender='Female' THEN 1 END) AS 'FEMALE' FROM evaluation WHERE acty_id='$evaluationID' ";
      ...
      <div class="card">
        <table class="subtable">
          ...
          //MEAN - CAST((COUNT(ethnicity)/COUNT(ethnicity)*100) AS DECIMAL(10,2)) AS ethnic_percent FROM `evaluation` WHERE acty_id='$q' ORDER BY id";
            $mean_for_ethnicity = "SELECT ethnicity,CAST((COUNT(ethnicity)/COUNT(ethnicity)*100) AS DECIMAL(10,2)) AS ethnic_percent FROM `evaluation` WHERE acty_id='$evaluationID' ORDER BY id";
            $mean_ethnicity_qry = mysqli_query($connect, $mean_for_ethnicity);
            $mean_ethnicity_row = mysqli_fetch_array($mean_ethnicity_qry);
            
            foreach($connect->query("SELECT DISTINCT ethnicity,COUNT(*) AS ethnic_counts FROM `evaluation` WHERE acty_id='$evaluationID' GROUP BY `ethnicity` ORDER BY id") as $ethnic_row_counts) {
          ?>
          <tbody>
            <tr>
      ...
      <div class="card">
        <table class="subtable">
          ...
          <?php 
            $mean_for_city = "SELECT ct_municipality,CAST((COUNT(*)/SUM(ct_municipality)*100) AS DECIMAL(10,2)) AS MeanCity FROM `evaluation` WHERE acty_id='$evaluationID' ORDER BY id";
            $mean_city_qry = mysqli_query($connect, $mean_for_city);
            $mean_city_row = mysqli_fetch_array($mean_city_qry);
              
            foreach($connect->query("SELECT DISTINCT ct_municipality,COUNT(*) AS city_counts FROM `evaluation` WHERE acty_id='$evaluationID' GROUP BY `ct_municipality` ORDER BY id") as $city_row_counts) {
          ?>
          <tbody>
            <tr>
      ...
      <div class="card">
        <table class="subtable">
          ...
          <?php 
            $mean_for_province = "SELECT provnce,CAST((COUNT(provnce)/COUNT(provnce)*100) AS DECIMAL(10,2)) AS MeanProvince FROM `evaluation` WHERE acty_id='$evaluationID' ORDER BY id";
            $mean_province_qry = mysqli_query($connect, $mean_for_province);
            $mean_province_row = mysqli_fetch_array($mean_province_qry);
              
            foreach($connect->query("SELECT DISTINCT provnce,COUNT(*) AS province_counts FROM `evaluation` WHERE acty_id='$evaluationID' GROUP BY `provnce` ORDER BY id") as $province_row_counts) {
          ?>
          <tbody>
            <tr>
        ...
        <table class="subtable">
          <?php
            ...
            $count_for_q1 = "SELECT q1, 
                                ...
                                FROM evaluation eval WHERE eval.acty_id='$evaluationID' ";
            ...
            $answers_for_q1 = "SELECT COUNT(q1) AS total_response_for_q1 FROM evaluation eval WHERE eval.acty_id='$evaluationID' ";
            ...
            $answers_for_q2 = "SELECT COUNT(q2) AS total_response_for_q2 FROM evaluation eval WHERE eval.acty_id='$evaluationID' ";
            ...
            $answers_for_q3 = "SELECT COUNT(q3) AS total_response_for_q3 FROM evaluation eval WHERE eval.acty_id='$evaluationID' ";
            ...
            $answers_for_q4 = "SELECT COUNT(q4) AS total_response_for_q4 FROM evaluation eval WHERE eval.acty_id='$evaluationID' ";
            ...
            $answers_for_q5 = "SELECT COUNT(q5) AS total_response_for_q5 FROM evaluation eval WHERE eval.acty_id='$evaluationID' ";
            ...
            $answers_for_q6 = "SELECT COUNT(q6) AS total_response_for_q6 FROM evaluation eval WHERE eval.acty_id='$evaluationID' ";
            ...
            $answers_for_q7 = "SELECT COUNT(q7) AS total_response_for_q7 FROM evaluation eval WHERE eval.acty_id='$evaluationID' ";
            ...
            $answers_for_q8 = "SELECT COUNT(q8) AS total_response_for_q8 FROM evaluation eval WHERE eval.acty_id='$evaluationID' ";
            ...
            $answers_for_q9 = "SELECT COUNT(q9) AS total_response_for_q9 FROM evaluation eval WHERE eval.acty_id='$evaluationID' ";
            ...
            $answers_for_q10 = "SELECT COUNT(q10) AS total_response_for_q10 FROM evaluation eval WHERE eval.acty_id='$evaluationID' ";
